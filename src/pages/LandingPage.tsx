          ...
          {images.length > 0 && (
            <div className="max-w-2xl mx-auto py-8">
              ...
              <div className="flex flex-col items-center mt-6 mb-8">
                ...
                {/* Add purchase count notification */}
                <div className="flex items-center justify-center mt-3 text-sm text-gray-600">
                  ...
                  <span>Purchased 1519 times this month</span>
                </div>

                {/* Add Trustpilot-style widget */}
                <div className="flex flex-col items-center mt-4 bg-[#00b67a] bg-opacity-10 py-3 px-4 rounded-lg">
                  <div className="flex items-center">
                    ...
                    <span className="ml-2 font-bold text-[#00b67a]">Excellent</span>
                  </div>
                  <div className="text-sm text-gray-600 mt-1">
                    Based on 14,500+ reviews
                  </div>
